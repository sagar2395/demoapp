      ...
      <div>
         <div
             ...
             <div class="w-full flex flex-col justify-center gap-4 md:text-left text-center text-white dark:text-gray-800 md:mt-0 sm:mt-8 mt-4">
                 ...
                 <p>Helloooooo there I am Experienced Devops Engineer with 5+ years of expertise in Cloud computing and devops tools like Microsoft Azure, Amazon AWS, Azure Devops, Terraform, Powershell, Docker and Kubernetes.</p>
