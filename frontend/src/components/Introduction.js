      ...
      <div>
         <div
             ...
             <div class="w-full flex flex-col justify-center gap-4 md:text-left text-center text-white dark:text-gray-800 md:mt-0 sm:mt-8 mt-4">
                 ...
                 <h3 class="capitalize text-rose-400">i'm <span class="typing text-green-500 dark:text-green-700">Devops Engineer</span></h3>
                 <p>Experienced Devops Engineer with 5+ years of expertise in Cloud computing and devops tools like Microsoft Azure, Amazon AWS, Azure Devops, Terraform, Powershell, Docker and Kubernetes </p>
